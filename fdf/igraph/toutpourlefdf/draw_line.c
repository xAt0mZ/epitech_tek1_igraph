...
** Last update Mon Dec  3 18:43:15 2012 louis-philippe baron
*/

#include	"htp.h"

int		draw_one(t_c2d *crd_1, t_c2d *crd_2, t_list *list, int color)
{
  int		x;
  int		y_put;
...
int		draw_five(t_c2d *crd_1, t_c2d *crd_2, t_list *list, int color)
{
  int		y;
  int		x_put;
...
int		draw_hori(t_c2d *crd_1, t_c2d *crd_2, t_list *list, int color)
{
  int		x;
...
int		draw_verti(t_c2d *crd_1, t_c2d *crd_2, t_list *list, int color)
{
  int		y;
...
int		draw_line(t_c2d *crd_1, t_c2d *crd_2, t_list *list, int color)
{
  int		ratiox;
  int		ratioy;
  int		dir;
