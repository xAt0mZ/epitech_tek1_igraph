...
** Last update Wed Jan  9 15:03:25 2013 louis-philippe baron
*/
...
static char	*cpy_buffer(char *buffer, char *save, int rd)
{
  char		*str;
  int		i;
  int		k;
...
static char	*save_end(char *res, char *save)
{
  char		*str;
  int		k;
  int		i;
...
static char	*cpy_to_res(char *save)
{
  char		*res;
  int		i;
